...
type ActiveComponent = 'home' | 'datatypes' | 'arrays' | 'calculator' | 'dates' | 'database';
...
function App() {
  ...
  const renderActiveComponent = () => {
    switch (activeComponent) {
      ...
      default:
        return (
          <>
            <h1 className="main-title" style={{color: '#ffffff', textShadow: '1px 2px 8px rgba(0,0,0,0.5)'}}>Introducción a React</h1>
  ...
  return (
    <>
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark mb-4" style={{padding: '1rem 0', width: '100vw', margin: 0, borderRadius: 0, left: 0, right: 0}}>
        <div className="container-fluid" style={{width: '100%', maxWidth: '100%', margin: 0, paddingLeft: '2rem', paddingRight: '2rem'}}>
          <button 
